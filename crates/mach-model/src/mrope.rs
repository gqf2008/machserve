...
mod tests {
    ...
    fn cos_sin_matches_hf_real_config() {
        ...
        let want = [
            (
                [-0.41614684, -0.23973489, 0.10987744],
                [0.90929741, 0.97083837, 0.99394512],
            ),
            (
                [-0.9899925, -0.74889243, 0.74494207],
                [0.14112, 0.66269153, 0.66712916],
            ),
            (
                [-0.65364361, 0.35433567, 0.45758203],
                [-0.7568025, 0.93511832, 0.88916743],
            ),
        ];
